    ...
    <main className="bg-bg-light dark:bg-bg-dark min-h-screen pt-32 transition-colors duration-300">
      <div className="container mx-auto px-6 max-w-7xl pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          {/* Contact Form */}
          <div className="lg:col-span-8 bg-white dark:bg-gray-900 border border-border-light dark:border-border-dark p-8 md:p-12 order-1 lg:order-2 shadow-sm">
            <form className="space-y-8">
              ...
              <div className="flex items-center gap-2">
                <input type="checkbox" id="consent" className="rounded border-gray-300 text-primary focus:ring-primary h-3 w-3" />
